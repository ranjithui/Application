package edu.holysai.app.ui.theme
...
// Holy Sai brand palette (frontend/src/styles/tokens.css)
val Magenta = Color(0xFF990033)
val MagentaDeep = Color(0xFF5C001D)
val MagentaTint = Color(0xFFFFF0F4)
val Gold = Color(0xFFFEDB6E)
val GoldDeep = Color(0xFFB87A04)
...
private val Light = lightColorScheme(
    ...
    primaryContainer = MagentaTint,
    onPrimaryContainer = MagentaDeep,
    secondary = GoldDeep,
    secondaryContainer = Color(0xFFFFF9E6),
    onSecondaryContainer = Color(0xFF5A3C00),
    tertiary = Teal,
...
@Composable
fun HolySaiTheme(content: @Composable () -> Unit) {
